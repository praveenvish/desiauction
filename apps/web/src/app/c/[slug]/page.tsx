    ...
    <main className="public-page">
      ...
      <header className="public-hero">
        ...
        <div className="public-hero-meta">
          <span data-testid="public-org">Organized by {view.orgName}</span>
          {view.location !== null ? <span>{view.location}</span> : null}
          <span>{formatDateRange(view.startsOn, view.endsOn)}</span>
        </div>
        <div>
        ...
        <div className="public-cta-row">
          ...
          <ButtonLink href="/c" variant="ghost">
            All competitions
          </ButtonLink>
        </div>
      </header>
      ...
      <section className="public-section" aria-labelledby="contact-heading">
        ...
        <p className="public-hint">
          ...
          with you. For anything about the DesiAuction platform itself, see <a href="/help">Help</a>
          .
        </p>
      </section>
    </main>
