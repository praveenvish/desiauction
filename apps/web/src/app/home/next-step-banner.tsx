...
/**
 * The ONE contained surface on /home (design rule: one panel per page). It says
 * where this is, the single thing to do, why, and what follows — the three
 * questions every console screen has to answer.
 */
export function NextStepBanner({ step }: { step: NextStep }) {
  return (
    <section
      className={`home-next home-next--${step.tone}`}
