...
export default async function MatchDayPage({
  ...
  const dayHref = (date: string) => `/competitions/${slug}/fixtures/match-day?date=${date}`;
  return (
    <ToastProvider>
        ...
        <div className="dash-stack">
          <header className="dash-head">
            <div className="competition-title-row">
              ...
              <ButtonLink href={`/competitions/${slug}/fixtures`} variant="secondary">
                Fixtures
              </ButtonLink>
            </div>
            <p className="competitions-hint">Match-day dashboard</p>
          </header>
