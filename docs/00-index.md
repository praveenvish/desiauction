...
| Domain | Index |
|--------|-------|
| **Financial Operations** (IP-6 · **frozen**) | [financial-operations/IP-6_ARCHITECTURE](financial-operations/IP-6_ARCHITECTURE.md) · [ADRS ×14](financial-operations/ADRS.md) · [EVENT_CATALOG](financial-operations/EVENT_CATALOG.md) · [SECURITY](financial-operations/SECURITY.md) · [RUNBOOKS](financial-operations/RUNBOOKS.md) · [REVIEW_PACKAGE](financial-operations/REVIEW_PACKAGE.md) · [IP-6 freeze](financial-operations/IP-6_FREEZE.md) · [IP-6 closure](financial-operations/IP-6_CLOSURE_REPORT.md) |
| **Settlement** (IP-5 · frozen) | [settlement/IP-5_ARCHITECTURE](settlement/IP-5_ARCHITECTURE.md) · [ADRS ×8](settlement/ADRS.md) · [EVENT_CATALOG](settlement/EVENT_CATALOG.md) · [SECURITY](settlement/SECURITY.md) · [RUNBOOKS](settlement/RUNBOOKS.md) · [IP-5 freeze](settlement/IP-5_FREEZE.md) |
